...
Begin VB.Form Form10 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command1 
         Caption         =   "Tüm Alacaklarin Hesapla"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
...
T1 = Round((Adodc1.Recordset.Fields("Alacagin") * 10000), 2) * 100 'yazýlan toplam
T1 = dblRoundOff(T1, 2)
T2 = Val(T2) + Val(T1)
...
ExcelNesne.Application.Cells(i, 7).Value = Adodc1.Recordset.Fields("Süre")
...
Adodc1.Recordset!Süre = Text16.Text
